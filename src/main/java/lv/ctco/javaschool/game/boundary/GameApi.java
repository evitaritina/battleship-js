...
public class GameApi {
    ...
    public void startGame() {
        ...
        Optional<Game> game = gameStore.getIncompleteGame();     //meklee vai ir nepabeigta speele

        game.ifPresent(g -> {               //ir nepabeigta speele
        ...
        if (!game.isPresent()) {              //nav nepabigtas speeles
